...
enum LocalModelProfile: String, CaseIterable, Codable, Identifiable, Sendable {
    ...
    var installationNote: String {
        switch self {
        case .smallFast:
            return "Install google_gemma-3-1b-it-Q4_K_M.gguf in ai/Models and include it in the app target."
        case .betterQuality:
            return "Install google_gemma-3-4b-it-Q4_K_M.gguf in ai/Models and include it in the app target. Use on higher-memory devices only."
        }
    }
