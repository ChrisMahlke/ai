...
struct SideMenuView: View {
    ...
    private var searchField: some View {
        HStack(spacing: 8) {
            Image(systemName: "magnifyingglass")
                ...
                .foregroundStyle(AppTheme.foreground.opacity(0.34))
        ...
        .background(
            RoundedRectangle(cornerRadius: 8, style: .continuous)
                .fill(AppTheme.foreground.opacity(0.065))
    ...
    private func menuButton(title: String, icon: String, action: @escaping () -> Void) -> some View {
        Button(action: action) {
            ...
            .background(
                RoundedRectangle(cornerRadius: 8, style: .continuous)
                    .fill(AppTheme.foreground.opacity(0))
            )
        }
        .buttonStyle(.plain)
    }
        ...
        HStack(spacing: 0) {
            Button {
                ...
                HStack(spacing: 12) {
                    Image(systemName: "message")
                        ...
                        .foregroundStyle(chat.isPinned ? AppTheme.foreground.opacity(0.78) : AppTheme.foreground.opacity(0.5))
                        .frame(width: 22)
            ...
            Button {
                ...
                Image(systemName: chat.isPinned ? "pin.fill" : "pin")
                    .font(.system(size: 12, weight: .medium))
                    .foregroundStyle(chat.isPinned ? AppTheme.foreground.opacity(0.68) : AppTheme.foreground.opacity(0.32))
    ...
    private func highlighted(_ value: String) -> AttributedString {
        ...
        while searchRange.location < nsValue.length {
            ...
            attributed.addAttribute(.backgroundColor, value: UIColor.label.withAlphaComponent(0.12), range: foundRange)
