...
struct HelpTroubleshootingPanel: View {
    private let items = [
        (
            title: "Model missing",
            text: "Open Models and confirm the selected profile is installed. If it is unavailable, add the GGUF file to falken/Models, include it in the app target, and rebuild."
        ),
        (
